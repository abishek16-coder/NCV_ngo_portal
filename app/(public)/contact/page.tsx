        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-5">
            ...
            <div className="lg:col-span-2 space-y-8">
              <div>
                <h2 className="text-2xl font-bold text-[#1B8271]">Reach Out to Us</h2>
                <p className="mt-3 text-[#1B8271] leading-relaxed">
              ...
              <div className="space-y-5">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-[#1B8271]">Address</h3>
                    <p className="mt-1 text-sm text-[#1B8271]">126, Balakumaran nagar part B Meenakshi Nagar,Thirupathi Nagar,Valasaravakkam , Chennai</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="flex size-10 shrink-0 items-center justify-center rounded-xl bg-[#1B8271]/10">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-[#1B8271]">Email</h3>
                    <p className="mt-1 text-sm text-[#1B8271]">narchinthanaivattam@gmail.com</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="flex size-10 shrink-0 items-center justify-center rounded-xl bg-[#1B8271]/10">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-[#1B8271]">Phone</h3>
                    <p className="mt-1 text-sm text-[#1B8271]">+91 90030 75333 ,+91 90031 33661 </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="flex size-10 shrink-0 items-center justify-center rounded-xl bg-[#1B8271]/10">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-[#1B8271]">Hours</h3>
                    <p className="mt-1 text-sm text-[#1B8271]">Mon - Sat: 8:00 AM - 6:00 PM</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              {sent ? (
                <div className="rounded-3xl border border-[#1B8271]/10 bg-white p-12 text-center">
                  <div className="mx-auto flex size-16 items-center justify-center rounded-full bg-[#1B8271]/10">
                    <Send className="size-7 text-[#1B8271]" />
                  </div>
                  <h3 className="mt-5 text-xl font-bold text-[#1B8271]">Message Sent!</h3>
                  <p className="mt-2 text-sm text-[#1B8271]">Thank you for reaching out. We will get back to you within 24-48 hours.</p>
                ...
                <form onSubmit={handleSubmit} className="rounded-3xl border border-[#1B8271]/10 bg-white p-8 shadow-lg">
                  <h3 className="text-xl font-bold text-[#1B8271]">Send a Message</h3>
                  <p className="mt-1 text-sm text-[#1B8271]">Fill out the form below and we will respond promptly.</p>
