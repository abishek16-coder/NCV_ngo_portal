    ...
    <div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#1B8271] via-[#1B8271] to-[#1B8271] py-20 sm:py-28">
        ...
        <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="mt-6 text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl">
            ...
            <span className="text-[#FF6B35]">Yoga & Service</span>
          </h1>
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <Link href="/projects" className="inline-flex items-center gap-2 rounded-full bg-[#FF6B35] px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-[#FF6B35]/30 transition-all hover:bg-[#FF6B35] hover:scale-[1.02]">
      ...
      <section className="py-16 sm:py-24 bg-white">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-8 md:grid-cols-2">
            <div className="rounded-3xl border border-[rgba(27, 130, 113, 0.1)] bg-gradient-to-br from-[#ffffff] to-white p-8 shadow-sm">
              <div className="flex size-12 items-center justify-center rounded-2xl bg-[#1B8271]/10">
                <Target className="size-6 text-[#1B8271]" />
              </div>
              <h2 className="mt-5 text-2xl font-bold text-[#1B8271]">Our Mission</h2>
              <p className="mt-3 leading-relaxed text-[#1B8271]">
            ...
            <div className="rounded-3xl border border-[rgba(27, 130, 113, 0.1)] bg-gradient-to-br from-[#ffffff] to-white p-8 shadow-sm">
              ...
              <h2 className="mt-5 text-2xl font-bold text-[#1B8271]">Our Vision</h2>
              <p className="mt-3 leading-relaxed text-[#1B8271]">
      ...
      <section className="py-16 sm:py-24 bg-[#ffffff]">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-[#1B8271] sm:text-4xl">Our Core Values</h2>
            <p className="mx-auto mt-4 max-w-2xl text-[#1B8271]">The principles that guide every initiative we undertake</p>
          </div>
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {values.map((v) => (
              <div key={v.title} className="group rounded-2xl border border-[#1B8271]/10 bg-white p-6 shadow-sm transition-all hover:shadow-md hover:border-[#1B8271]/20">
                ...
                <h3 className="mt-4 text-lg font-bold text-[#1B8271]">{v.title}</h3>
                <p className="mt-2 text-sm leading-relaxed text-[#1B8271]">{v.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 sm:py-24 bg-white">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-[#1B8271] sm:text-4xl">Our Journey</h2>
            <p className="mt-4 text-[#1B8271]">Key milestones in our mission to transform communities</p>
          </div>
          <div className="relative mt-12">
            <div className="absolute left-4 top-0 bottom-0 w-0.5 bg-gradient-to-b from-[#1B8271] to-[#1B8271]" />
            <div className="space-y-8">
              {milestones.map((m, i) => (
                <div key={m.year} className="relative pl-12">
                  ...
                  <div className="rounded-xl border border-[#1B8271]/10 bg-white p-4 shadow-sm">
                    <span className="text-sm font-bold text-[#1B8271]">{m.year}</span>
                    <p className="mt-1 text-sm text-[#1B8271]">{m.event}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      {/* CTA */}
      <section className="py-16 sm:py-20 bg-gradient-to-r from-[#1B8271] to-[#1B8271]">
        <div className="mx-auto max-w-4xl px-4 text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link href="/volunteer" className="inline-flex items-center gap-2 rounded-full bg-[#FF6B35] px-6 py-3 text-sm font-semibold text-white shadow-lg transition-all hover:bg-[#FF6B35] hover:scale-[1.02]">
